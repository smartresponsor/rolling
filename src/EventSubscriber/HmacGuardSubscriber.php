...
namespace App\Rolling\EventSubscriber;
...
/** Event subscriber implementation for HmacGuardSubscriber. */
final class HmacGuardSubscriber implements EventSubscriberInterface
{
    ...
    /** Returns the Symfony events handled by this subscriber. */
    public static function getSubscribedEvents(): array
    {
        return [KernelEvents::REQUEST => ['onKernelRequest', 102]];
    }

    /** Validates the incoming request before controller execution. */
