...
<<<<<<< HEAD
use App\Infrastructure\Symfony\DependencyInjection\RoleExtension as CanonicalRoleExtension;
=======
use App\Audit\Role\PdoAuditWriter;
...
use Http\Security\Replay\PdoStore;
use PDO;
use Policy\Role\Client\V2\RemotePdpV2;
...
use Policy\Role\Registry\InMemorySource;
...
final class RoleExtension extends CanonicalRoleExtension
{
<<<<<<< HEAD
=======
    /**
    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        // Controllers
        $container->register('role.controller.v2', RoleApiV2Controller::class)
        ...
        if ($config['security']['hmac_enabled'] && $config['security']['hmac_secret']) {
            $container->register('role.hmac.verifier', HmacVerifier::class)
            ...
            if ($config['security']['anti_replay']['enabled'] && $config['security']['anti_replay']['pdo_dsn']) {
                ...
                $container->register('role.replay.store', PdoStore::class)
