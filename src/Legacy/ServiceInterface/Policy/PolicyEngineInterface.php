...
namespace App\Legacy\ServiceInterface\Policy;

use App\Legacy\Service\Policy\Decision;
...
interface PolicyEngineInterface
{
    ...
    /**
     * @param \App\Legacy\ServiceInterface\Policy\VoterInterface $voter
     * @return void
     */
     ...
     * @param array $context
     * @return \App\Legacy\Service\Policy\Decision
     */
