...
namespace App\Service\Role\Approval;

use src\ServiceInterface\Role\Approval\ApprovalGateInterface;
...
{
    /**
     * @param \src\ServiceInterface\Role\Approval\ApprovalStoreInterface $store
     * @param array $rule
     */
