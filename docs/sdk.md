...
- Java: `javac $(find sdk/java/role/src/main/java -name "*.java") && java -cp sdk/java/role/src/main/java com.smartresponsor.role.example.Main` — consumer/domain Java package locator.
