...
- Normalized `src/ServiceInterface/ObligationStoreInterface.php` to the canonical namespace `App\ServiceInterface`.
...
- Canonical code under `src/ServiceInterface/*` now uses the canonical `App\ServiceInterface` root consistently.
