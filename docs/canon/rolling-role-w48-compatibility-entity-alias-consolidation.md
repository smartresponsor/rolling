...
Changes:
- moved `App\\Legacy\\Entity\\Role\\PermissionKey` alias into `legacy_role_compatibility_core.php`
- moved `App\\Legacy\\Entity\\Role\\Scope` alias into `legacy_role_compatibility_core.php`
- moved `App\\Legacy\\Entity\\Role\\SubjectId` alias into `legacy_role_compatibility_core.php`
