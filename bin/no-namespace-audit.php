...
namespace App\Bin {
    function noNamespaceAuditRun(): int
    {
        ...
        $allowlist = [
            ...
            'bin/role-policy.php',
            'bin/role-rebac.php',
            'src/Legacy/Compatibility/legacy_role_alias_support.php',
            'src/Legacy/Compatibility/legacy_role_aliases_bootstrap.php',
            'src/Legacy/Compatibility/legacy_role_global_aliases.php',
            'src/Legacy/Compatibility/legacy_role_namespace_aliases.php',
            'src/Legacy/Compatibility/legacy_role_w04_aliases.php',
            'src/Legacy/Compatibility/legacy_role_w05_aliases.php',
            'src/Legacy/Compatibility/legacy_role_w06_aliases.php',
            'src/Legacy/Compatibility/legacy_role_w07_aliases.php',
            'src/Legacy/Compatibility/legacy_role_w08_aliases.php',
            'src/Legacy/Compatibility/legacy_role_w09_aliases.php',
            'src/Legacy/Compatibility/legacy_role_w10_aliases.php',
            'src/Legacy/Compatibility/role_sdk_exception_aliases.php',
